...
class script(object):
    START_TXT = """<b>ʜᴇʟʟᴏ {},  ɪ ᴀᴍ {}, ɪ ᴡᴏʀᴋ ғᴏʀ ɢᴇɴ ʜᴇɴᴛᴀɪ ɴᴇᴛᴡᴏʀᴋ... ɪ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ʏᴏᴜ ᴛʜᴇ ᴛʜɪɴɢs ʏᴏᴜ ʜᴀᴠᴇ ʙᴇᴇɴ ᴄʀᴀᴠɪɴɢ ғᴏʀ... ɪ ᴍᴇᴀɴ ʜᴇɴᴛᴀɪ</b>"""
    
    CAPTION = """<b>📂 ʜᴇɴᴛᴀɪ ғɪʟᴇɴᴀᴍᴇ : {file_name}

⚙️ ʜᴇɴᴛᴀɪ sɪᴢᴇ : {file_size}

Jᴏɪɴ [ʜᴇɴᴛᴀɪ ᴄʜᴀɴɴᴇʟ](https://t.me/+N6UtkCUdZL9iZWY1)</b>""" 
...
📚 ʟɪʙʀᴀʀʏ: <a href=https://docs.pyrogram.org>𝐏𝐲𝐫𝐨𝐠𝐫𝐚𝐦</a></b>
"""
